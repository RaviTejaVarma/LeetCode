...
|---|---------|----------|------|------------|
| 1 | [Contains Duplicate](https://neetcode.io/problems/duplicate-integer/question) | [duplicate_number.ts](solutions/typescript/duplicate_number.ts) | [duplicate_number.test.ts](solutions/typescript/test_cases/duplicate_number.test.ts) | Easy |
